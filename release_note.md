...
--------------------------------
1. Bugs
	1. crash when typing enter to connect the server. 
	2. crash when remote updating title.

2. Other changes
	1. modeless cmd dialog and cmd group.
...
--------------------------------
1. Bugs
	1. The auto-commanders in sub-sessions may be messed up with its folder when changed.
    2. The port is not savable.
	3. Tips for sending a large file(over 4GB) through zmodem.
...
--------------------------------
1. Bugs	
	1. Screen Locked when moving/maximizing the window.
	2. rz failed on Mac.

2. Other changes
	1. Support -save/-del options on the commander line.
	2. Add desc column to portforwards config view.

--------------------------------
putty-nd6.7
--------------------------------
1. Bugs	
	1. When downloading all sessions from google drive, the local sessions' names are shown in a mess.
	2. Not to scale with the screen for win10.
	3. Sometimes, the Ctrl + Enter is not working in commander editor dialog.
